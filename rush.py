...
def task_enter_hold():
    """1. Hold Enter 1s every 15s. Cycle: Run 4h, Stop 1h."""
    ...
    interval = 15.0
    hold_duration = 1.0
    print(f"[P1: {interval}sE] Process started. Cycle: R{RUN_DURATION/3600:.1f}h / S{STOP_DURATION/3600:.1f}h.")
    ...
    while True:
        ...
        while (time.monotonic() - cycle_start) < RUN_DURATION:
            ...
            if sleep_time > 0:
                ...
                time.sleep(0.1) # Minimal sleep to prevent busy-waiting
